...
if($page == 2) $color = "#949AF6";
if($page == 4) $color = "#EA92C4";
if($page == 6) $color = "#652FEB";
if($page == 8) $color = "#FDAB96";
if($page == 10) $color = "#652FEB";

?>

<div class="page-content">
    <section class="test-step test-step--type2 step-<?= $gender ?>-<?= $page ?>" data-nextcolor="<?= $color ?>" data-step="<?= $data_step ?>">
