...
if($args):
	...
	<section class="section screen screen-01 cursor-container" data-start="#F9F3E9" data-end="#F9F3E9">
		...
		<div class="container">
			...
			<div class="buttons">
				...
				<?php if ($link_1): ?>
					<a href="<?= the_permalink(324) ?>" class="btn btn-start btn-start--white"<?php if($link_1['target']) echo ' target="_blank"' ?> id="start_2">
						<span class="btn-main">
