...
function add_styles() {
    ...
    //wp_enqueue_style('my-popups', get_template_directory_uri().'/assets/css/popups.css');
    //wp_enqueue_style('my-fancybox', get_template_directory_uri().'/assets/css/jquery.fancybox.min.css');
...
function add_scripts() {
    ...
    wp_enqueue_script( 'my-fancybox', get_template_directory_uri() . '/assets/js/jquery.fancybox.min.js', array(), false, true);



    if (is_page_template('page-templates/landing.php') || is_page_template('page-templates/promo.php')  ) {
    ...
    if (is_singular('result') || is_page_template('page-templates/pricing.php')) {
        ...
        if (is_singular('result')) {
            ...
            elseif (get_field('payment') == 'Advanced') wp_enqueue_script( 'my-result-advanced', get_template_directory_uri() . '/assets/js/result-advanced.js', array(), false, true);
            else wp_enqueue_script( 'my-result', get_template_directory_uri() . '/assets/js/result.js', array(), false, true);
        } else{
            wp_enqueue_script( 'my-result', get_template_directory_uri() . '/assets/js/result-new.js', array(), false, true);
        }
    }
    ...
    if (!is_singular('result')) wp_enqueue_script( 'forms', get_template_directory_uri() . '/assets/js/forms.js', array(), false, true);
    ...
    wp_enqueue_script( 'popups', get_template_directory_uri() . '/assets/js/popups.js', array(), false, true);
