            ...
            <div class="col">
              <div class="item">
                ...
                <div class="price">
                  ...
                  <?php if ($field = get_field('payment_results_basic', 'option')['old_price']): ?>
                    <span><?= $field ?></span>
                  <?php endif ?>
                  
                  <?php if ($field = get_field('payment_results_basic', 'option')['price']): ?>
                    <strong><?= $field ?></strong>
                  <?php endif ?>
                ...
                <?php if ($field = get_field('payment_results_basic', 'option')['link']): ?>
                  <a href="<?= $field['url'] ?>" class="btn btn-pink"<?php if($field['target']) echo ' target="_blank"' ?>>
