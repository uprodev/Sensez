        ...
        <section class="section block-gift block-gift-form">
            ...
            <div class="form">
                ...
                <form action="#" id="formGift">
                    ...
                    <div class="field">
                        <input type="text" name="name" value="<?= $values['billing_first_name'] ?>" placeholder="Your name/nickname*" required>
                    </div>
                    <div class="field">
                        <input type="email" name="email" value="<?= $values['billing_email'] ?>" placeholder="Your email*" required>
                    </div>
                    <div class="field field-optional">
                        <input type="email" name="recepient_email" placeholder="Recipient’s e-mail (optional)">
                    </div>
                    <div class="field field-optional">
                        <textarea id="textarea" name="note" placeholder="Personal message (optional)"></textarea>
                    </div>
