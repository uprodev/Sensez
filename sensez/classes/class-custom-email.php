    ...
    function trigger( $item_id ) {
        ...
        if ( $item_id && $send_email ) {
          ...
          //  print_r($this->get_headers());
            $this->send( 'oleg.derimedved@gmail.com', 'You have a Gift!',  $this->get_content(), $this->get_headers(), 1 );
